...
if (!class_exists('registerpage')) {
    class registerpage
    {
        ...
        {
            register_activation_hook(__FILE__,  [$this, 'register_page_on_activation']);
            // add_action('wp_head', [$this, 'create_plugin_database_table']);
            add_filter('the_content', [$this, 'pagecreate_register']);
        }

        function register_page_on_activation()
        {
            if (!current_user_can('activate_plugins')) return;
        }
        public function pagecreate_register()
        {
            $post_values = '';
            ...
            $new_page = array(
                ...
                'post_title'    => 'Registration',    // Title of the CoFntent
